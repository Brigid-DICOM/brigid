...
import { EventActionCode, EventOutcomeIndicator } from "../services/dicom/dicomAudit";
import { logDicomInstancesTransferred } from "../services/dicom/dicomAuditFactory";

export const auditDicomInstancesTransferredMiddleware = createMiddleware(async (c, next) => {
    await next();
