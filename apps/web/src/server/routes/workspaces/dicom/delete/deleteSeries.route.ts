...
const deleteSeriesRoute = new Hono().post(
    "/workspaces/:workspaceId/dicom/series/delete",
    describeRoute({
        description: "Delete DICOM series",
        tags: ["DICOM"]
    }),
    ...
    async (c) => {
        ...
        const result = await deleteService.deleteSeries(
            workspaceId,
...
export default deleteSeriesRoute;