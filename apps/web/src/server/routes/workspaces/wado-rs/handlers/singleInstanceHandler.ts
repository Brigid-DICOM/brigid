...
import { wadoUriParamsToConvertOptions } from "@/server/utils/dicom/converter/convertOptions";
...
export class SingleInstanceHandler implements WadoResponseHandler {
