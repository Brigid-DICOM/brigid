...
.get(
    ...
    describeRoute({
        description: "Retrieve DICOM study instances (WADO-RS), ref: [Retrieve Transaction Study Resources](https://dicom.nema.org/medical/dicom/current/output/html/part18.html#table_10.4.2-1)",
        tags: ["WADO-RS"]
    }),
