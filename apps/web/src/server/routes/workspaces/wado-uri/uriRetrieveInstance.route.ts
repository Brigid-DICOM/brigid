...
const uriRetrieveInstanceRoute = new Hono().get(
    "/workspaces/:workspaceId/wado-uri",
    describeRoute({
        description:
            "Retrieve DICOM instance (WADO-URI), ref: [URI Service](https://dicom.nema.org/medical/dicom/current/output/html/part18.html#chapter_9)",
        tags: ["WADO-URI"],
    }),
