...
export const searchStudySeriesQueryParamSchema =
    searchStudiesQueryParamSchema.extend({
        SeriesInstanceUID: z.string().optional(),
        [DICOM_TAG_KEYWORD_REGISTRY.SeriesInstanceUID.tag]: z
            .string()
            .optional(),
        ...
        [DICOM_TAG_KEYWORD_REGISTRY.SeriesDescription.tag]: z
            .string()
            .optional(),
        ...
        "RequestAttributesSequence.ScheduledProcedureStepID": z
            .string()
            .optional(),
        [NESTED_TAG_KEYS.RequestAttributesSequence_ScheduledProcedureStepID]: z
            .string()
            .optional(),

        "RequestAttributesSequence.RequestedProcedureID": z.string().optional(),
        [NESTED_TAG_KEYS.RequestAttributesSequence_RequestedProcedureID]: z
            .string()
            .optional(),

        "RequestAttributesSequence.AccessionNumber": z.string().optional(),
        [NESTED_TAG_KEYS.RequestAttributesSequence_AccessionNumber]: z
            .string()
            .optional(),

        "RequestAttributesSequence.StudyInstanceUID": z.string().optional(),
        [NESTED_TAG_KEYS.RequestAttributesSequence_StudyInstanceUID]: z
            .string()
            .optional(),

        "RequestAttributesSequence.IssuerOfAccessionNumberSequence.LocalNamespaceEntityID":
            z.string().optional(),
        [NESTED_TAG_KEYS.RequestAttributesSequence_IssuerOfAccessionNumberSequence_LocalNamespaceEntityID]:
            z.string().optional(),

        "RequestAttributesSequence.IssuerOfAccessionNumberSequence.UniversalEntityID":
            z.string().optional(),
        [NESTED_TAG_KEYS.RequestAttributesSequence_IssuerOfAccessionNumberSequence_UniversalEntityID]:
            z.string().optional(),

        "RequestAttributesSequence.IssuerOfAccessionNumberSequence.UniversalEntityIDType":
            z.string().optional(),
        [NESTED_TAG_KEYS.RequestAttributesSequence_IssuerOfAccessionNumberSequence_UniversalEntityIDType]:
            z.string().optional(),
    });

export type SearchStudySeriesQueryParam = z.infer<
    typeof searchStudySeriesQueryParamSchema
>;
