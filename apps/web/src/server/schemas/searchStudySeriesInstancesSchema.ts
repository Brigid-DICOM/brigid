...
export const searchStudySeriesInstancesQueryParamSchema =
    searchStudySeriesQueryParamSchema
        .extend({
            ...
            [DICOM_TAG_KEYWORD_REGISTRY.SOPInstanceUID.tag]: z
                .string()
                .optional(),
...
export type SearchStudySeriesInstancesQueryParam = z.infer<
    typeof searchStudySeriesInstancesQueryParamSchema
>;
