...
export const shareAssignTagSchema = z.object({
    tags: z
        ...
        .min(1)
        .describe("Tags to create/update and assign"),
    targets: z
        .array(
            z.object({
                targetType: z.enum(["study", "series", "instance"]),
        ...
        .min(1)
        .describe("Targets to assign tags to"),
...
export type RemoveTagAssignmentPayload = z.infer<
    typeof removeTagAssignmentSchema
>;
