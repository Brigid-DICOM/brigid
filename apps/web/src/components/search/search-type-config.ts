...
export const SEARCH_TYPE_CONFIGS: SearchTypeConfig[] = [
    {
        ...
        dicomLevel: "study",
        routePattern: new RegExp(`^\\/${LNG_PATTERN}\\/[\\w-]+\\/dicom-studies(?:\\?.*)?$`),
    },
    {
        key: "dicom-series",
        label: "DICOM Series",
        ...
        dicomLevel: "series",
        routePattern: new RegExp(`^\\/${LNG_PATTERN}\\/[\\w-]+\\/dicom-studies\\/[\\d.]+(?:\\?.*)?$`),
    },
    {
        key: "dicom-instance",
        ...
        dicomLevel: "instance",
        routePattern: new RegExp(`^\\/${LNG_PATTERN}\\/[\\w-]+\\/dicom-studies\\/[\\d.]+\\/series\\/[\\d.]+(?:\\?.*)?$`),
    },
    {
        ...
        routePattern: new RegExp(`^\\/${LNG_PATTERN}\\/[\\w-]+\\/dicom-recycle\\/studies(?:\\?.*)?$`),
    },
    {
        ...
        routePattern: new RegExp(`^\\/${LNG_PATTERN}\\/[\\w-]+\\/dicom-recycle\\/studies\\/[\\d.]+\\/series(?:\\?.*)?$`),
    },
    {
        ...
        routePattern: new RegExp(`^\\/${LNG_PATTERN}\\/[\\w-]+\\/dicom-recycle\\/studies\\/[\\d.]+\\/series\\/[\\d.]+\\/instances(?:\\?.*)?$`),
    },
]
