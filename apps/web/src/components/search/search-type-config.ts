...
export const SEARCH_TYPE_CONFIGS: SearchTypeConfig[] = [
    ...
    },
    {
        ...
        dicomLevel: "series",
        routePattern: /^\/[\w-]+\/dicom-studies\/([\d.]+)(?:\?.*)?$/,
    },
    {
        key: "dicom-instance",
        ...
        dicomLevel: "instance",
        routePattern: /^\/[\w-]+\/dicom-studies\/([\d.]+)\/series\/([\d.]+)(?:\?.*)?$/,
    },
    {
        ...
        routePattern: /^\/[\w-]+\/dicom-recycle\/studies(?:\?.*)?$/,
    },
    {
        ...
        routePattern: /^\/[\w-]+\/dicom-recycle\/studies\/([\d.]+)\/series(?:\?.*)?$/,
    },
    {
        ...
        routePattern: /^\/[\w-]+\/dicom-recycle\/studies\/([\d.]+)\/series\/([\d.]+)\/instances(?:\?.*)?$/,
    },
]
