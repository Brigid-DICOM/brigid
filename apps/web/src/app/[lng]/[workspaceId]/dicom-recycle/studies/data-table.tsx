...
function ActionsCell({
    ...
    const { mutate: restoreDicomStudy } = useMutation({
        ...
        onMutate: () => {
            toast.loading(t("dicom.messages.restoring", { level: "study" }), {
                id: `restore-${studyInstanceUid}`,
            });
        },
        onSuccess: () => {
            toast.success(t("dicom.messages.restoreSuccess", { level: "study" }));
        ...
        onError: () => {
            toast.error(t("dicom.messages.restoreError", { level: "study" }));
            toast.dismiss(`restore-${studyInstanceUid}`);
        },
    });
    ...
    const { mutate: deleteDicomStudy } = useMutation({
        ...
        onMutate: () => {
            toast.loading(t("dicom.messages.deleting", { level: "study" }), {
                id: `delete-${studyInstanceUid}`,
            });
        },
        onSuccess: () => {
            toast.success(t("dicom.messages.deleteSuccess", { level: "study" }));
        ...
        onError: () => {
            toast.error(t("dicom.messages.deleteError", { level: "study" }));
            toast.dismiss(`delete-${studyInstanceUid}`);
        },
    });
    ...
    const handleEnterSeries = (e: React.MouseEvent<HTMLDivElement>) => {
        e.stopPropagation();
        clearSelection();
        router.push(`/${lng}/${workspaceId}/dicom-recycle/studies/${studyInstanceUid}/series`);
    };
