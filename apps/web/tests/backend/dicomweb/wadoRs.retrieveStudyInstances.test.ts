...
describe("WADO-RS Study Route", () => {
    ...
    describe("GET /workspaces/:workspaceId/studies/:studyInstanceUid", () => {
        it('should retrieve study instances with multipart/related; type="application/dicom"', async () => {
            // Act
            const response = await app.request(
                `/api/workspaces/${WORKSPACE_ID}/studies/${TEST_DICOM_DATA.studyInstanceUid}`,
                {
                    headers: {
        ...
        it("should retrieve study instances as zip", async () => {
            // Act
            const response = await app.request(
                `/api/workspaces/${WORKSPACE_ID}/studies/${TEST_DICOM_DATA.studyInstanceUid}`,
                {
        ...
        it('should retrieve study instances as multipart/related; type="image/jpeg"', async () => {
            // Act
            const response = await app.request(
                `/api/workspaces/${WORKSPACE_ID}/studies/${TEST_DICOM_DATA.studyInstanceUid}`,
                {
        ...
        it('should retrieve study instances as multipart/related; type="image/jp2"', async () => {
            // Act
            const response = await app.request(
                `/api/workspaces/${WORKSPACE_ID}/studies/${TEST_DICOM_DATA.studyInstanceUid}`,
                {
        ...
        it('should retrieve study instances as multipart/related; type="image/png"', async () => {
            // Act
            const response = await app.request(
                `/api/workspaces/${WORKSPACE_ID}/studies/${TEST_DICOM_DATA.studyInstanceUid}`,
                {
        ...
        it("should handle quality parameter", async () => {
            // Act
            const response = await app.request(
                `/api/workspaces/${WORKSPACE_ID}/studies/${TEST_DICOM_DATA.studyInstanceUid}?quality=85`,
                {
                    headers: {
                        accept: 'multipart/related; type="image/jpeg"',
                    },
        ...
        it("should reject invalid quality parameter", async () => {
            ...
            for (const params of invalidParams) {
                // Act
                const response = await app.request(
                    `/api/workspaces/${WORKSPACE_ID}/studies/${TEST_DICOM_DATA.studyInstanceUid}?${new URLSearchParams(params)}`,
                );
                // Assert
        ...
        it("should handle iccprofile parameter", async () => {
            // Act
            const response = await app.request(
                `/api/workspaces/${WORKSPACE_ID}/studies/${TEST_DICOM_DATA.studyInstanceUid}?iccprofile=srgb`,
                {
                    headers: {
                        accept: 'multipart/related; type="image/jpeg"',
                    },
        ...
        it("should return 404 for non-existent series", async () => {
            ...
            // Act
            const response = await app.request(
                `/api/workspaces/${WORKSPACE_ID}/studies/${nonExistentStudy}`,
            );
            // Assert
    ...
    describe("Service Error Handling", () => {
        it("should handle StudyService errors", async () => {
            ...
            const studyPath = `/api/workspaces/${WORKSPACE_ID}/studies/${TEST_DICOM_DATA.studyInstanceUid}`;

            // Act
            const response = await app.request(studyPath, {
                headers: {
                    accept: 'multipart/related; type="application/dicom"',
                },
            });
